...
```sh
skaffold -m lcogt-commissioning-deps run
```

Start application development loop:

```sh
skaffold -m lcogt-commissioning dev
```

If there are any Ingresses, they should be exposed at:
  - https://lcogt-commissioning.local.lco.earth
  - https://dependency-lcogt-commissioning.local.lco.earth
